...
(function (window, document, undefined) {
    ...
    dcevent = function (dcApi, formatData) {
        'use strict';
        var id, contest, select, eventsApi = {}, apiBaseUrl = 'https://danceconvention.net/eventdirector/rest/', apiUrlContainer = document.querySelector('script[data-dcevent-api]'), containers = document.querySelectorAll('[data-dcevent]'), i = containers.length, output = function (container) {
